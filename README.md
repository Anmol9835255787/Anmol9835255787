...
<head>
    ...
    <title>Anmol Sinha's Portfolio</title>
    <style>
        body {
...
<body>
    <h1 class="typing-effect">Hi there! 👋 I'm Anmol Sinha</h1>
    <h3>A passionate developer from IIIT-Allahabad</h3>

    <p>
        🌱 Currently learning: <strong>MERN stack</strong><br>
        💬 Ask me about: <strong>React.js, JavaScript, Classical ML, DSA</strong><br>
        📫 Reach me at: <a href="mailto:anmolsinhaamit@gmail.com">anmolsinhaamit@gmail.com</a><br>
        📄 Explore my experiences: <a href="https://drive.google.com/file/d/1iavl4b9dg0C5_cqeoQJ7RuPuYrweSv2B/view?usp=sharing" target="_blank"><strong>Resume</strong></a><br>
    ...
    <h3>Random Quote:</h3>
    <p class="quote">
        <img src="https://api.api-ninjas.com/v1/quotes?category=happiness" alt="Random Quote" />
    </p>
</body>
</html>
